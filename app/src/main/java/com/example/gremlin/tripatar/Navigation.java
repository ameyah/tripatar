...
//        System.out.println( "---------------------"+getIntent().getStringExtra("objId").toString() );
        final Data data = (Data)getIntent().getSerializableExtra("getawayData");
        TextView tvTitle = (TextView) findViewById(R.id.TitleText);
        TextView tvDuration = (TextView) findViewById(R.id.DurationText);
